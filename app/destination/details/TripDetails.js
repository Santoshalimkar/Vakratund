...
import ItemThumbnailsDemo from './ItinerarySlider'
...
<div className="flex justify-around mt-10 container">
  <div className="w-1/2">
  <div className='flex flex-col gap-0 items-start justify-start w-full'>
    ...
    <div className='flex flex-row gap-2 items-center justify-start w-full'>
      <p className='flex items-center gap-1 sm:gap-1.5 text-xs text-white bg-[radial-gradient(169.40%_89.55%_at_70.76%_-2.29%,rgba(0,0,0,0.1)_20%,rgba(11,141,122,1)_90%)] rounded-md px-1'>7D/8N<span className='pl-1 py-0.5'></span></p>
      <p className='flex items-center gap-1 sm:gap-1.5 text-xs text-white bg-[radial-gradient(169.40%_89.55%_at_70.76%_-2.29%,rgba(0,0,0,0.1)_20%,rgba(11,141,122,1)_90%)] rounded-md px-1'>Customized Trip<span className='pl-1 py-0.5'></span></p>
      <p className='flex items-center gap-1 sm:gap-1.5 text-xs text-white bg-[radial-gradient(169.40%_89.55%_at_70.76%_-2.29%,rgba(0,0,0,0.1)_20%,rgba(11,141,122,1)_90%)] rounded-md px-1'>Bali Airport

<span className='pl-1 py-0.5'></span></p>
    </div>
    <div className='flex flex-row gap-2 items-center justify-start w-full mt-2'>
      <div className='flex flex-col gap-2 py-4 items-start justify-start w-full'>
        ...
        <div className='flex flex-row gap-2 items-center justify-start w-full'><p className='relative max-w-fit flex flex-row gap-2 items-center justify-start w-full text-lg font-bold text-gray-600'>INR <span className='text-2xl font-bold'>50000/-</span><span className='absolute top-1/2 left-0 w-full h-0.5 bg-red-500'></span></p><span className='inline-flex text-xs md:text-sm rounded-full justify-center text-center px-1 md:px-2 items-center     bg-[#0b8d7c] font-medium text-white'>4% OFF</span></div>
...
Embark on an unforgettable Bali adventure with our meticulously planned trip, designed to give you an authentic taste of this Indonesian paradise. This journey takes you through the vibrant artsy town of Ubud, the lively Gili Islands, and the trendy hotspots of Seminyak. Whether you’re a thrill-seeker or a relaxation enthusiast, this Bali itinerary has something for everyone. Your adventure begins in Ubud, the cultural heart of Bali. Known for its lush forests, stunning waterfalls, expansive rice fields, and majestic volcanic mountains, Ubud is the perfect starting point for your Bali journey. Check into your accommodation and get ready for an evening of relaxation. Meet your fellow travelers during an ice-breaking session, setting the stage for new friendships and shared experiences.
    ...
    <div className='flex flex-col gap-6'>
      <h2 className='text-xl md:text-2xl lg:text-3xl font-[500] flex flex-row gap-2'>Itinerary
        <span className='lucide -mt-3 lucide-sparkles h-4 w-4 text-[#36a39e] shrink-0'><i className="pi pi-sparkles" style={{ fontSize: '1rem' }}></i></span></h2>
  ...
  <div className="w-96"><ItemThumbnailsDemo/></div>
</div>
