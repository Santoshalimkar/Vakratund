            ...
            <div className="py-24 relative">
              <div className="h-full w-full max-w-7xl mx-auto relative md:px-8 lg:px-10 xl:px-0 flex flex-col gap-10 px-0">
                ...
                <ul className="flex flex-col gap-4 list-decimal pl-6 md:pl-8 lg:pl-10">
                        ...
                        <li>The photos/videos content created on Desh Videsh trip (by Desh Videsh content creators or clients) is the property of Desh Videsh and can only be used by Desh Videsh Experiences for advertising across media platforms. None of the digital content can be used by anyone for advertising/commercial use without obtaining the rightful permissions by Desh Videsh.</li>
                        ...
                        <li>People traveling with Desh Videsh for International travel are advised that their passport must be valid for at least six (6) months from the date of intended travel and not damaged in any way. Desh Videsh does not take any responsibility for clients who book travel with passports that do not meet this requirement. It is the responsibility of the client to ensure that their passport is valid for the required period before making any travel bookings through Desh Videsh. Any denial of entry at immigration, and any additional cost arising out of alternate arrangements for deporting has to be borne by the travellers.</li>
