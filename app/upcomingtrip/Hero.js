  ...
  return (
    <div className="relative">
      ...
      <div className="sticky top-16 sm:top-0 h-[85vh] sm:h-[75vh] flex items-center justify-center">
        ...
        <div className="absolute top-2 left-0 h-full text-white w-full flex flex-col justify-end pb-8 xl:pb-36 lg:pb-36 items-center">
      ...
      <div className="pt-10 pb-20 md:pt-14 bg-white relative flex flex-col">
        <div className="h-full w-full max-w-7xl mx-auto relative md:px-8 lg:px-10 flex flex-col gap-20 px-6 xl:px-0">
          <div className="relative bg-white rounded-2xl shadow-[0px_4px_30px_0px_rgba(0,0,0,0.15)] p-8 flex flex-col gap-6">
            ...
            >
              <p>
                {`Vakratund Travels is a travel agency that offers a wide range of
                travel packages for both domestic and international
                destinations. We have a team of experienced professionals who
                are dedicated to providing you with the best travel experience
                possible. Our upcoming destinations are carefully curated to
                ensure that you have a memorable and enjoyable trip. Whether you
                are looking for a relaxing beach vacation, an adventurous
                trekking expedition, or a cultural tour, we have something for
                everyone. So why wait? Book your next trip with Desh Videsh
                Travels today and start exploring the world!`}
              </p>
            </div>
