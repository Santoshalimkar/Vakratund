      ...
      <div className="flex flex-col justify-center items-start gap-4 mt-16">
        <div className="w-11/12 mx-auto">
          <h6 className="font-bold text-3xl mt-8">
            Happy
            <span className=" ml-2"> customers             <span className='lucide absolute ml-2 -mt-3 lucide-sparkles h-4 w-4 text-[#36a39e] shrink-0'><i className="pi pi-sparkles" style={{ fontSize: '1rem' }}></i></span>
</span>{" "}
          </h6>
        </div>
      </div>
